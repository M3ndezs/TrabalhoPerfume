...
public class Base {
    ...
    public void limpar() {
        if (!lista.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "impossivel limpar uma lista vazia!");
        }
    }
    
    public void pesquisar(String produto){
        if(lista.contains(produto)){
            JOptionPane.showMessageDialog(null, "O perfume '" + produto + "' foi encontrado");
        }else{
            JOptionPane.showMessageDialog(null, "o perfume '" + produto + "' não foi encontrado");
        }
    }
}
